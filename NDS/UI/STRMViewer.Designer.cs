namespace NDS.UI
{
	partial class STRMViewer
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "STRMViewer";
			this.Text = "STRMViewer";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.STRMViewer_FormClosed);
			this.Load += new System.EventHandler(this.STRMViewer_Load);
