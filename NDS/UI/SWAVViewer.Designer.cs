namespace NDS.UI
{
	partial class SWAVViewer
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "SWAVViewer";
			this.Text = "SWAVViewer";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.SWAVViewer_FormClosed);
			this.Load += new System.EventHandler(this.SWAVViewer_Load);
