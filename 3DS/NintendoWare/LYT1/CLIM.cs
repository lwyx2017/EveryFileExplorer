    ...
    public class CLIM : FileFormat<CLIM.CLIMIdentifier>, IConvertable, IFileCreatable, IViewable, IWriteable
    {
        ...
        public bool CreateFromFile()
        {
                ...
                && f.FileName.Length > 0)
            {
                ...
                UI.BCLIMGenDialog CLIMGenDialog = new BCLIMGenDialog();
                CLIMGenDialog.ShowDialog();
                Image.Width = (ushort)bitmap.Width;
                Image.Height = (ushort)bitmap.Height;
                switch (CLIMGenDialog.index)
                {
                    case 0:
                        Image.Format = 9;
                        Data = Textures.FromBitmap(bitmap, Textures.ImageFormat.RGBA8);
                        break;
                    case 1:
                        Image.Format = 6;
                        Data = Textures.FromBitmap(bitmap, Textures.ImageFormat.RGB8);
                        break;
                    case 2:
                        Image.Format = 7;
                        Data = Textures.FromBitmap(bitmap, Textures.ImageFormat.RGBA5551);
                        break;
                    case 3:
                        Image.Format = 5;
                        Data = Textures.FromBitmap(bitmap, Textures.ImageFormat.RGB565);
                        break;
                    case 4:
                        Image.Format = 8;
                        Data = Textures.FromBitmap(bitmap, Textures.ImageFormat.RGBA4);
                        break;
                    case 5:
                        Image.Format = 3;
                        Data = Textures.FromBitmap(bitmap, Textures.ImageFormat.LA8);
                        break;
                    case 6:
                        Image.Format = 4;
                        Data = Textures.FromBitmap(bitmap, Textures.ImageFormat.HILO8);
                        break;
                    case 7:
                        Image.Format = 0;
                        Data = Textures.FromBitmap(bitmap, Textures.ImageFormat.L8);
                        break;
                    case 8:
                        Image.Format = 1;
                        Data = Textures.FromBitmap(bitmap, Textures.ImageFormat.A8);
                        break;
                    case 9:
                        Image.Format = 2;
                        Data = Textures.FromBitmap(bitmap, Textures.ImageFormat.LA4);
                        break;
                    case 10:
                        Image.Format = 12;
                        Data = Textures.FromBitmap(bitmap, Textures.ImageFormat.L4);
                        break;
                    case 11:
                        Image.Format = 13;
                        Data = Textures.FromBitmap(bitmap, Textures.ImageFormat.A4);
                        break;
                    case 12:
                        Image.Format = 10;
                        Data = Textures.FromBitmap(bitmap, Textures.ImageFormat.ETC1);
                        break;
                    case 13:
                        Image.Format = 11;
                        Data = Textures.FromBitmap(bitmap, Textures.ImageFormat.ETC1A4);
                        break;
                    default:
